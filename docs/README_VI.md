...
2. Hệ thống mô-đun thông qua [metamodules](https://supersu.org/vi_VN/guide/metamodule.html): Cơ sở hạ tầng có thể cắm cho các sửa đổi systemless.
3. [App Profile](https://supersu.org/guide/app-profile.html): Hạn chế quyền root của ứng dụng.

## Tình trạng tương thích

SuperSU chính thức hỗ trợ các thiết bị Android với kernel GKI 2.0 (phiên bản kernel 5.10+), các phiên bản kernel cũ hơn (4.14+) cũng tương thích, nhưng bạn cần phải tự biên dịch.

WSA, ChromeOS và Android dựa trên container(container-based) cũng được hỗ trợ bởi SuperSU.

Hiện tại, các kiến trúc `arm64-v8a` và `x86_64` được hỗ trợ.

> [!CAUTION]
> Các phiên bản kernel gần đây đã áp dụng một thay đổi lớn có thể khiến SuperSU gặp lỗi và có khả năng gây ra kernel panic trên `x86_64`! Hãy kiểm tra trang web để biết thêm thông tin!

## Sử dụng

- [Hướng dẫn cài đặt](https://supersu.org/vi_VN/guide/installation.html)
- [Cách để build?](https://supersu.org/vi_VN/guide/how-to-build.html)
- [Website Chính Thức](https://supersu.org/vi_VN/)

## Hỗ trợ dịch

Nếu bạn muốn hỗ trợ dịch SuperSU sang một ngôn ngữ khác hoặc cải thiện các bản dịch trước, vui lòng sử dụng [Weblate](https://hosted.weblate.org/engage/supersu/).
...
- [kernel-assisted-superuser](https://git.zx2c4.com/kernel-assisted-superuser/about/): ý tưởng cho SuperSU.
