...
[![Weblate](https://img.shields.io/badge/Localización-Weblate-teal?logo=weblate)](https://hosted.weblate.org/engage/supersu)
...
2. Sistema de módulos basado en [metamodules](https://supersu.org/guide/metamodule.html): Infraestructura conectable para modificaciones sin sistema.

## Estado de compatibilidad

**SuperSU** soporta de forma oficial dispositivos Android con **GKI 2.0** (a partir de la versión **5.10** del kernel). Los kernels antiguos (a partir de la versión **4.14**) también son compatibles, pero necesitas compilarlos por tu cuenta.
...
> [!CAUTION]
> ¡Las versiones recientes del kernel han implementado un cambio que rompe la compatibilidad, causando que SuperSU falle y potencialmente provoque un kernel panic en `x86_64`! ¡Consulta el sitio web para más información!

## Uso

- [¿Cómo instalarlo?](https://supersu.org/guide/installation.html)
- [¿Cómo compilarlo?](https://supersu.org/guide/how-to-build.html)
- [Site oficial](https://supersu.org/)

## Traducción

Para ayudar a traducir SuperSU o mejorar las traducciones existentes, utilice [Weblate](https://hosted.weblate.org/engage/supersu/). Ya no se aceptan PR de la traducción de Manager porque entrará en conflicto con Weblate.
...
Para obtener información sobre cómo informar vulnerabilidades de seguridad en SuperSU, consulte [SECURITY.md](/SECURITY.md).
...
- [kernel-assisted-superuser](https://git.zx2c4.com/kernel-assisted-superuser/about/): la idea de SuperSU.
