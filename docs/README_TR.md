...
2. [metamodules](https://supersu.org/guide/metamodule.html)'ye dayalı modül sistemi: Systemless modifikasyonlar için takılabilir altyapı.
3. [Uygulama profili](https://supersu.org/guide/app-profile.html): Root gücünü bir kafese kapatın.

## Uyumluluk Durumu

SuperSU resmi olarak Android GKI 2.0 cihazlarını (5.10+ kernelli) destekler, eski kernellerle de (4.14+) uyumludur, ancak kerneli kendinizin derlemeniz gerekir.
...
> [!CAUTION]
> Yeni çekirdek sürümleri, SuperSU'nun çökmesine ve `x86_64` üzerinde kernel panic tetiklemesine neden olabilecek uyumsuz bir değişiklik uyguladı! Daha fazla bilgi için web sitesini kontrol edin!

## Kullanım

- [Yükleme yönergeleri](https://supersu.org/guide/installation.html)
- [Nasıl derlenir?](https://supersu.org/guide/how-to-build.html)
- [Resmi WEB sitesi](https://supersu.org/)

## Çeviri

SuperSU'nun başka dillere çevrilmesine veya mevcut çevirilerin iyileştirilmesine yardımcı olmak için lütfen [Weblate](https://hosted.weblate.org/engage/supersu/) kullanın. Yönetici uygulamasının PR ile çevirisi, Weblate ile çakışacağından artık kabul edilmeyecektir.
...
SuperSU'daki güvenlik açıklarını bildirme hakkında bilgi için, bkz [SECURITY.md](/SECURITY.md).
...
- [kernel-assisted-superuser](https://git.zx2c4.com/kernel-assisted-superuser/about/): SuperSU fikri.
