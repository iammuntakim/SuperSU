...
2. [metamodules](https://supersu.org/guide/metamodule.html) पर आधारित मॉड्यूल प्रणाली: Systemless संशोधनों के लिए प्लगेबल इंफ्रास्ट्रक्चर।
3. [App Profile](https://supersu.org/guide/app-profile.html): Root शक्ति को पिंजरे में बंद कर दो।

## अनुकूलता अवस्था

SuperSU आधिकारिक तौर पर Android GKI 2.0 डिवाइस (कर्नेल 5.10+) का समर्थन करता है। पुराने कर्नेल (4.14+) भी संगत हैं, लेकिन कर्नेल को मैन्युअल रूप से बनाना होगा।
...
> [!CAUTION]
> हाल ही के कर्नेल संस्करणों में एक ऐसा बदलाव लागू किया गया है जिससे SuperSU विफल हो सकता है और `x86_64` पर कर्नेल पैनिक (kernel panic) ट्रिगर हो सकता है! अधिक जानकारी के लिए वेबसाइट देखें!

## प्रयोग

- [स्थापना निर्देश](https://supersu.org/guide/installation.html)
- [कैसे बनाना है ?](https://supersu.org/guide/how-to-build.html)
- [आधिकारिक वेबसाइट](https://supersu.org/)

## अनुवाद करना

SuperSU का अनुवाद करने या मौजूदा अनुवादों को बेहतर बनाने में सहायता के लिए, कृपया इसका उपयोग करें [Weblate](https://hosted.weblate.org/engage/supersu/).
...
- [kernel-assisted-superuser](https://git.zx2c4.com/kernel-assisted-superuser/about/): SuperSU विचार।
