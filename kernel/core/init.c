...
__attribute__((naked)) int __init supersu_init_early(void)
{
    asm("mov x19, x30;\n"
...
int __init supersu_init(void)
{
    ...
    if (!boot_cpu_has(X86_FEATURE_INDIRECT_SAFE)) {
        ...
        pr_alert("**      SuperSU will abort initialization to prevent      **");
    ...
    pr_alert("**     NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE    **");
    pr_alert("**                                                         **");
    pr_alert("**         You are running SuperSU in DEBUG mode          **");
    pr_alert("**                                                         **");
    pr_alert("**     NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE    **");
    pr_alert("*************************************************************");
#endif
...
module_init(supersu_init_early);
#else
module_init(supersu_init);
#endif
module_exit(supersu_exit);

MODULE_LICENSE("GPL");
MODULE_AUTHOR("weishu");
MODULE_DESCRIPTION("Android SuperSU");
