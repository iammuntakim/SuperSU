...
import com.android.superuser.KernelVersion
                            ...
                            if (state.currentManagerVersionCode < (state.ksuVersion ?: 0)) {
                                ...
                                WarningCard(
                                    stringResource(
                                        ...
                                        state.ksuVersion ?: 0,
                                        com.android.superuser.Natives.MINIMAL_SUPPORTED_KERNEL
                                    )
                                )
                            }
                        }
...
private fun LearnMoreCard(
    ...
    val url = stringResource(R.string.home_learn_supersu_url)
    Card(modifier = Modifier.fillMaxWidth()) {
        BasicComponent(
            title = stringResource(R.string.home_learn_supersu),
            summary = stringResource(R.string.home_click_to_learn_supersu),
            endActions = {
                Icon(
