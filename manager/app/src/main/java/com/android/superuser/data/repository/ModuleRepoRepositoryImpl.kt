...
import com.android.superuser.data.model.Author
import com.android.superuser.data.model.ReleaseAsset
...
class ModuleRepoRepositoryImpl : ModuleRepoRepository {
    ...
    companion object {
        private const val MODULES_URL = "https://modules.supersu.org/modules.json"
    }
