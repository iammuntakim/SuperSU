package com.android.superuser.ui.component.miuix
...
import com.android.superuser.ui.component.dialog.LoadingDialogHandle
import com.android.superuser.ui.util.getBugreportFile
        ...
        content = {
            ...
            ArrowPreference(
                ...
                onClick = {
                    ...
                    exportBugreportLauncher.launch("SuperSU_bugreport_${current}.tar.gz")
                    onDismissRequest()
                },
