...
import com.android.superuser.ui.viewmodel.ModuleRepoViewModel
import com.android.superuser.ui.viewmodel.ModuleViewModel
...
fun ModuleRepoDetailScreen(module: RepoModuleArg) {
    ...
    var webUrl by remember(module.moduleId) { mutableStateOf("https://modules.supersu.org/module/${module.moduleId}") }
    var sourceUrl by remember(module.moduleId) { mutableStateOf("https://github.com/SuperSU-Modules-Repo/${module.moduleId}") }
