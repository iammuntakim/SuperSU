package com.android.superuser.magica;

import static com.android.superuser.magica.AppZygotePreload.TAG;
...
import com.android.superuser.ui.util.KsuCliKt;
...
public class BootCompletedReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (!Intent.ACTION_LOCKED_BOOT_COMPLETED.equals(action)
                ...
                && !"com.android.superuser.magica.LAUNCH".equals(action)) {
            return;
        }
