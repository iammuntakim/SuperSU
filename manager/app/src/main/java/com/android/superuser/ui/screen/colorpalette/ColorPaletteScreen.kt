...
import com.android.superuser.SuperSUApplication
...
import com.android.superuser.ui.viewmodel.SettingsViewModel
...
fun ColorPaletteScreen() {
    ...
    val actions = ColorPaletteScreenActions(
        ...
        onSetEnablePredictiveBack = {
            ...
            SuperSUApplication.setEnableOnBackInvokedCallback(context.applicationInfo, it)
            activity?.recreate()
        },
