...
enum Commands {
    ...
    LateLoad {
        ...
        #[arg(long, default_value_t = String::from("com.android.superuser"))]
        package_name: String,
    },
    ...
    /// Install SuperSU userspace component to system
    Install {
        #[arg(long, default_value = None)]
        libadbroot: Option<PathBuf>,
    },

    /// Unload SuperSU kernel module (LKM Only)
    Unload,

    /// Uninstall SuperSU modules and itself(LKM Only)
    Uninstall {
        #[arg(long, default_value_t = String::from("com.android.superuser"))]
        package_name: String,
    },
    ...
    /// Restore boot or init_boot images patched by SuperSU
...
enum Debug {
    ...
    SetManager {
        /// manager package name
        #[arg(default_value_t = String::from("com.android.superuser"))]
        apk: String,
    },
    ...
    let result = match cli.command {
        ...
        Commands::Services => {
            if ksucalls::get_version() <= 0 {
                info!("SuperSU not available, exiting services");
                std::process::exit(0);
            }
