...
export default defineConfig({
  ...
  themeConfig: {
    ...
    footer: {
        ...
        copyright: 'Copyright © 2022-现在 SuperSU 开发者。'
    },
...
function nav() {
  return [
    { text: '指南', link: '/zh_CN/guide/what-is-supersu' },
  ]
}
  ...
  return [
    {
        text: 'Guide',
        items: [
          { text: '什么是 SuperSU？', link: '/zh_CN/guide/what-is-supersu' },
          { text: 'SuperSU 模块与 Magisk 的差异', link: '/zh_CN/guide/difference-with-magisk' },
          { text: '安装', link: '/zh_CN/guide/installation' },
          { text: '如何构建？', link: '/zh_CN/guide/how-to-build' },
          { text: '如何为非 GKI 设备集成 SuperSU', link: '/zh_CN/guide/how-to-integrate-for-non-gki'},
