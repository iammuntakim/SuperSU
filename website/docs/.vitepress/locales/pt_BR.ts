...
export default defineConfig({
  ...
  themeConfig: {
    ...
    footer: {
        ...
        copyright: 'Copyright © 2022-presente Desenvolvedores do SuperSU.'
    },
...
function nav() {
  return [
    { text: 'Guia', link: '/pt_BR/guide/what-is-supersu' },
  ]
}
  ...
  return [
    {
        text: 'Guia',
        items: [
          { text: 'O que é SuperSU?', link: '/pt_BR/guide/what-is-supersu' },
