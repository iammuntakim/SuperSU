...
export default defineConfig({
  ...
  themeConfig: {
    ...
    footer: {
        ...
        copyright: 'Авторские права © 2022-текущее Разработчики SuperSU.'
    },
...
function nav() {
  return [
    { text: 'Руководство', link: '/ru_RU/guide/what-is-supersu' },
  ]
}
  ...
  return [
    {
        text: 'Руководство',
        items: [
          { text: 'Что такое SuperSU?', link: '/ru_RU/guide/what-is-supersu' },
