...
export default defineConfig({
  ...
  themeConfig: {
    ...
    footer: {
        ...
        copyright: 'Copyright © 2022-目前 SuperSU 開發人員。'
    },
...
function nav() {
  return [
    { text: '指南', link: '/zh_TW/guide/what-is-supersu' },
  ]
}
  ...
  return [
    {
        text: 'Guide',
        items: [
          { text: '什麼是 SuperSU？', link: '/zh_TW/guide/what-is-supersu' },
          { text: 'SuperSU 與 Magisk 的差異', link: '/zh_TW/guide/difference-with-magisk' },
          { text: '安裝', link: '/zh_TW/guide/installation' },
          { text: '如何建置？', link: '/zh_TW/guide/how-to-build' },
          { text: '如何為非 GKI 核心整合 SuperSU', link: '/zh_TW/guide/how-to-integrate-for-non-gki'},
