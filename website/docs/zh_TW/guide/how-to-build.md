# 如何建置 SuperSU? {#how-to-build-supersu}

::: warning
該文件僅供存檔參考，不再維護更新。
自 SuperSU v3.0 版本之後，為了更快的迭代和建置速度，我們放棄了對 GKI 映像模式的官方支援。推薦使用 `Ylarod/ddk` 建置 LKM 使用。
:::
...
::: warning 警告
此文件適用於 GKI 裝置，如果您是舊版核心，請參閱[如何為非 GKI 裝置整合 SuperSU](how-to-integrate-for-non-gki)
:::
...
## 與 SuperSU 一起建置核心 {#build-kernel-with-supersu}

如果您可以成功建置核心，那麼建置 SuperSU 就會非常輕鬆，依自己的需求在核心原始碼根目錄中執行以下任一命令：
...
然後重新建置核心，您將會得到一個帶有 SuperSU 的核心映像！
