...
Since SuperSU v3.0, we have dropped official support for GKI image mode for faster iteration and build speed. It is recommended to use `Ylarod/ddk` to build LKM.
:::
...
## Build kernel with SuperSU

If you can successfully build the kernel, adding support for SuperSU will be relatively easy. In the root of kernel source directory, run any of the options listed below:
...
Then, rebuild the kernel and you will get a kernel image with SuperSU!
