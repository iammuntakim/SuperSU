...
::: warning
该文档仅供存档参考，不再维护更新。
自 SuperSU v3.0 版本之后，为了更快的迭代和构建速度，我们放弃了对 GKI 镜像模式的官方支持。推荐使用 `Ylarod/ddk` 构建 LKM 使用。
:::
...
::: warning
本文档适用于 GKI 设备，如果你是旧内核，请参考[如何为非GKI设备集成 SuperSU](how-to-integrate-for-non-gki)
:::
...
如果您可以成功构建内核，那么构建 SuperSU 就很容易，根据自己的需求在内核源代码根目录中运行以下任一命令：
