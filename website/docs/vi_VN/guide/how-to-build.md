# Làm thế nào để xây dựng SuperSU?

::: warning
Tài liệu này chỉ để tham khảo lưu trữ và không còn được duy trì.
Kể từ SuperSU v3.0, chúng tôi đã ngừng hỗ trợ chính thức cho chế độ ảnh GKI để có tốc độ lặp và build nhanh hơn. Khuyến nghị sử dụng `Ylarod/ddk` để build LKM.
:::
...
::: warning
Trang này dành cho thiết bị GKI, nếu bạn sử dụng kernel cũ, vui lòng tham khảo [cách tích hợp SuperSU cho kernel cũ](how-to-integrate-for-non-gki)
:::
...
## Build Kernel với SuperSU

Nếu bạn có thể build kernel thành công thì việc xây dựng SuperSU thật dễ dàng, Chọn bất kỳ một lần chạy trong thư mục gốc nguồn Kernel:
...
Và sau đó build lại kernel và bạn sẽ có được image kernel với SuperSU!
