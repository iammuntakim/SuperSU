...
features:
  - title: Dựa trên Kernel
    details: SuperSU đang hoạt động ở chế độ kernel Linux, nó có nhiều quyền kiểm soát hơn đối với các ứng dụng userspace.
  ...
  - title: Quyền root bị hạn chế
    details: SuperSU cho phép bạn tùy chỉnh uid, gid, group, capabilities và các quy tắc SELinux của su. Giới hạn sức mạnh của root.
