# Bagaimana caranya untuk build SuperSU?

::: warning
Dokumen ini hanya untuk referensi arsip dan tidak lagi diperbarui.
Sejak SuperSU v3.0, kami telah menghentikan dukungan resmi untuk mode gambar GKI demi iterasi dan kecepatan build yang lebih cepat. Disarankan untuk menggunakan `Ylarod/ddk` untuk membangun LKM.
:::
...
> Halaman ini untuk perangkat GKI, jika Anda menggunakan kernel lama, silakan lihat [cara mengintegrasikan SuperSU untuk kernel lama](how-to-integrate-for-non-gki)
...
## Build Kernel dengan SuperSU

Jika Anda dapat build kernel dengan sukses, maka build SuperSU sangatlah mudah, jalankan perintah ini di root dir kernel source:
...
Dan kemudian build ulang kernel dan Anda akan mendapatkan image kernel dengan SuperSU!
